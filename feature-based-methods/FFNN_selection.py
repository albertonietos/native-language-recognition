...
# lr_lst = [0.0001 * 100, 0.0001 * 1000]
lr_lst = [0.0001 * 10000, 0.0001 * 100000]
train_list, dev_list = [], []
for lr in lr_lst:
    for l2 in lmbd:
        for h_size in h_sz:
...
"""
lr=1e-05, l2=1e-05, h_size=200, train_uar=0.98, dev_uar=0.49
lr=1e-05, l2=0.0001, h_size=200, train_uar=0.99, dev_uar=0.49
lr=1e-05, l2=0.001, h_size=200, train_uar=0.99, dev_uar=0.49
lr=1e-05, l2=0.01, h_size=200, train_uar=0.99, dev_uar=0.50
lr=0.0001, l2=1e-05, h_size=200, train_uar=1.00, dev_uar=0.50
lr=0.0001, l2=0.0001, h_size=200, train_uar=1.00, dev_uar=0.50
lr=0.0001, l2=0.001, h_size=200, train_uar=1.00, dev_uar=0.51
lr=0.0001, l2=0.01, h_size=200, train_uar=1.00, dev_uar=0.51
lr=0.001, l2=1e-05, h_size=200, train_uar=1.00, dev_uar=0.50
lr=0.001, l2=0.0001, h_size=200, train_uar=1.00, dev_uar=0.50
lr=0.001, l2=0.001, h_size=200, train_uar=1.00, dev_uar=0.51
lr=0.001, l2=0.01, h_size=200, train_uar=1.00, dev_uar=0.51
"""

"""
lr=0.01, l2=1e-05, h_size=200, train_uar=1.00, dev_uar=0.50
lr=0.01, l2=0.0001, h_size=200, train_uar=1.00, dev_uar=0.50
lr=0.01, l2=0.001, h_size=200, train_uar=1.00, dev_uar=0.50
lr=0.01, l2=0.01, h_size=200, train_uar=1.00, dev_uar=0.51
lr=0.1, l2=1e-05, h_size=200, train_uar=1.00, dev_uar=0.50
lr=0.1, l2=0.0001, h_size=200, train_uar=1.00, dev_uar=0.49
lr=0.1, l2=0.001, h_size=200, train_uar=1.00, dev_uar=0.50
lr=0.1, l2=0.01, h_size=200, train_uar=1.00, dev_uar=0.51
"""

"""
lr=1.0, l2=1e-05, h_size=200, train_uar=1.00, dev_uar=0.49
lr=1.0, l2=0.0001, h_size=200, train_uar=1.00, dev_uar=0.49
lr=1.0, l2=0.001, h_size=200, train_uar=1.00, dev_uar=0.50
lr=1.0, l2=0.01, h_size=200, train_uar=1.00, dev_uar=0.50
lr=10.0, l2=1e-05, h_size=200, train_uar=1.00, dev_uar=0.49
lr=10.0, l2=0.0001, h_size=200, train_uar=1.00, dev_uar=0.49
lr=10.0, l2=0.001, h_size=200, train_uar=1.00, dev_uar=0.50
lr=10.0, l2=0.01, h_size=200, train_uar=1.00, dev_uar=0.51
"""
# %% Add dropout to MLP
